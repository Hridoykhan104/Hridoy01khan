...
def menu_apikey():
  ...
  print("""\x1b[1;97m
    ...
    └───────────────────────────────────────┘""")
  print(f"\t \033[1;32m Admin By MD HRIDOY KHAN \033[1;37m ")
  print(f"")
  print(f"\t \033[1;32m  Best Paid Tools Of MD HRIDOY KHAN  \033[1;37m ")
  print(f"")
  ...
  try:
    httpCaht = requests.get("https://github.com/Hridoykhan104/HRIDOY01/blob/main/HRIDOY01.txt").text
    if id in httpCaht:
